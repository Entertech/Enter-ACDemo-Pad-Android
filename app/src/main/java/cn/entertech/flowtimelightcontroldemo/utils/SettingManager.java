...
import static cn.entertech.flowtimelightcontroldemo.app.Constant.SP_APP_KEY;
import static cn.entertech.flowtimelightcontroldemo.app.Constant.SP_APP_SECRET;
import static cn.entertech.flowtimelightcontroldemo.app.Constant.SP_SETTING;
    ...
    public static SettingManager getInstance() {
        if (null == mInstance) {
            synchronized (SettingManager.class) {
                if (null == mInstance) {
                    mInstance = new SettingManager(cn.entertech.flowtimelightcontroldemo.app.Application.Companion.getInstance());
                }
            }
        }
        return mInstance;
