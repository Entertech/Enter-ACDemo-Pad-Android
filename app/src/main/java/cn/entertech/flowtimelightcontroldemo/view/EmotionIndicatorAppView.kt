...
import cn.entertech.flowtimelightcontroldemo.R
import cn.entertech.flowtimelightcontroldemo.utils.ScreenUtil

class EmotionIndicatorAppView @JvmOverloads constructor(
    context: Context,
    ...
    fun init(context: Context, attrs: AttributeSet?) {
        var typeArray = context.obtainStyledAttributes(attrs, R.styleable.EmotionIndicatorView)
    ...
    fun initIndicateItem() {
        indicateItems.add(IndicateItem(0.2f, Color.parseColor("#ffccd2")))
        indicateItems.add(IndicateItem(0.5f, Color.parseColor("#ff98a9")))
        indicateItems.add(IndicateItem(0.3f, Color.parseColor("#cc5268")))
    }
